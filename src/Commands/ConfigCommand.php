...
class ConfigCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'geography:config';
     ...
     * @var string
     */
    protected $description = 'Creates the configuration files for geography.';
    ...
    {
        $this->laravel->view->addNamespace('geography', substr(__DIR__, 0, -8).'views');
        $this->line('');
        $this->info("Geography Config Creation.");
        $this->line('');
    ...
    {
        $base = "Geography config already exist.\nFollowing file was found: ";
